...
This dashboard simulates a real-world stakeholder report. Each chart is interactive—clicking a city or segment filters all views—allowing executives and analysts to explore performance drivers and take action with one click.Below is the overview page from the Tableau dashboard and more examples are included throughout thr report. The entire interactive dashboard can be downloaded here: [https://public.tableau.com/shared/YR7ZRB4J5?:display_count=n&:origin=viz_share_link](https://public.tableau.com/views/GloriaJeansCoffeesEDAAnalysis/GloriaJeanssCoffeesRevenueAnalysis?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
